              ...
              return (
                <li key={index}>
                  <button
                    ...
                    className={
                      currentPage == index + 1
                        ? "flex items-center justify-center px-3 h-8 leading-tight text-gray-50 bg-green-600 border border-green-600 hover:bg-green-800 hover:text-gray-50 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
