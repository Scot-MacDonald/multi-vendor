    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 ">
      ...
      <div className="flex gap-2">
        <input
          ...
          name="email"
          id="email"
          className="text-2xl font-light tracking-[0.11px] text-black dark:text-white p-4 border-1 border-black dark:border-[#666666] bg-transparent appearance-none text-center w-full placeholder:text-center placeholder-black dark:placeholder-[#cccccc] focus:ring-green-300 focus:border-green-300"
