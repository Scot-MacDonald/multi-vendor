...
export default function CartItems({ cartItems }) {
  return (
    <div className="md:col-span-7 sm:col-span-full col-span-full  p-5 border border-black dark:border-[#666666]">
      ...
      <div className="flex items-center gap-2 py-4">
        ...
        />
        <button className="shrink-0 py-2 px-4 bg-black dark:bg-transparent border border-black dark:border-white text-white font-normal">
          Apply Coupon
        </button>
      </div>
    </div>
