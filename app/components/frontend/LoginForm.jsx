    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 ">
      ...
      <div className="flex gap-8 items-center justify-center pt-4">
        <Link
          ...
          className="shrink-0 font-medium text-black hover:underline dark:text-white text-center "
        >
          Forgot your password?
        </Link>
      </div>

      <div className="text-sm font-light text-gray-500 dark:text-gray-400 pt-3 flex items-center gap-2">
