  ...
  return (
    <div>
        ...
        <div className="col-span-8">
          ...
          <div className="">
            ...
            <div className="flex items-center gap-3">
              <Image src="/weed.jpeg" width = {250} height = {250} alt = "Alt text" className = "rounded-xl w-20 h-20" />
            ...
            <div className="flex items-center gap-2">
              <h4>49</h4>
              <button><Trash2 className="text-red-600 w-5 h-5"/></button>
            </div>
            </div> 
            {/* CART 2 */}
            <div className="flex items-center justify-between border-b border-slate-400 pb-3 font-semibold text-sm mb-4">
          ...
          <input type="text" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-1/2" placeholder="Enter Coupon" />
          <button className="shrink-0 py-2.5 px-4 bg-black text-white font-normal">Apply Coupon</button>
          </div>
      ...
      <div className="col-span-4 md:block border border-dashed border-gray-900/25 dark:border-[#666666] rounded-md overflow-hidden p-5 font-bold">
        ...
        <p className="border-b border-slate-400 pb-3 font-normal">A text here about the shipping prices or whatever is useful.</p>
        <div className="flex items-center justify-between py-4 font-bold">
          <span>Total</span>
          <span>€100</span>
        </div>
        <Link href="#" className="bg-black text-white py-2 px-4 font-normal">Continue to Payment</Link>
      </div>
    </div>
    </div>
  );
