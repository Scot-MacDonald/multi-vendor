...
export default async function ProductDetailPage({ params: { slug } }) {
  ...
  return (
    <div className="w-full">
      <Breadcrumb />
      <div className="grid grid-cols-12 gap-8  p-3 border-l-8 border-r-8 border-b-8  border-[#f8f8f8] dark:border-[#303030]">
        ...
        <div className="col-span-6">
          ...
          <div className="border-b border-dashed border-gray-900/25">
            <p className="py-2">
              This is a sample text to see the product page. Hope it's working.
              This is a sample text to see the product page. Hope it's working.
            </p>
        ...
        <div className="col-span-3 hidden md:block border border-dashed border-gray-900/25 dark:border-[#666666] rounded-md overflow-hidden">
          <h2 className="bg-slate-100 dark:bg-gray-800 py-4 px-6 font-semibold border-b border-gray-300 dark:border-gray-600 text-slate-800 dark:text-slate-100">
